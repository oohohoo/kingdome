 ...
 /*  const loader = select('.loader'); */
  ...
  tlLoaderOut
   ...
   /*  .to(lines, {yPercent: -500, stagger: 0.2}, 0) */
    ...
    .to(".aspect-video", { scale:1, duration: 0.3, ease:'expo.inOut'}, 0.2)
    .to(".homeani1", {autoAlpha:1, stagger: 0.12, ease: "expo.inOut"}, 0.3)
    .from(".header_redflag", { yPercent:-100, ease:'expo.inOut'},  0.3)
